...
class WelcomesControllerTest < ActionController::TestCase
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post :create, welcome: { leyenda: @welcome.leyenda, logo: @welcome.logo, mensaje: @welcome.mensaje, name: @welcome.name }
    end
  ...
  test "should update welcome" do
    put :update, id: @welcome, welcome: { leyenda: @welcome.leyenda, logo: @welcome.logo, mensaje: @welcome.mensaje, name: @welcome.name }
    assert_redirected_to welcome_path(assigns(:welcome))
  end
